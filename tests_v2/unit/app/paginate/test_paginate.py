...
async def test_offset_is_0_for_page_1_when_size_is_given():
    ...
    await paginate_datasets(crud_impl=spy_get_datasets, datasets_count_impl=dummy_count_datasets, size=10, page=1)
...
async def test_offset_is_0_when_no_page_is_given():
    ...
    await paginate_datasets(crud_impl=spy_get_datasets, datasets_count_impl=dummy_count_datasets, size=10)
...
async def test_offset_is_10_for_page_2_when_page_size_is_10():
    ...
    await paginate_datasets(crud_impl=spy_get_datasets, datasets_count_impl=dummy_count_datasets, size=10, page=2)
