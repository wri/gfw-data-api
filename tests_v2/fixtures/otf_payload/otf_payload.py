environment = [
    ...
    },
    {
        ...
        "no_data": 0,
        "raster_table": None,
        "decode_expression": "(A.astype('timedelta64[D]') + np.datetime64('2015-01-01', 'D')).astype(str)",
        "encode_expression": "(np.datetime64(A, 'D') - np.datetime64('2015-01-01', 'D')).astype(uint16)",
