...
tags_desc_list = [{"name": "Dataset", "description": "Datasets are just a bucket, for datasets which share the same core metadata"},
                  {"name": "Version", "description": """Datasets can have different versions. Versions aer usually 
                  ...
                  """},
                  {"name": "Sources", "description": """Sources are input files to seed new dataset version. Supported types are
...
* GeoJSON
                  """},
                  {"name": "Assets", "description": """Assets are replicas of the original source files. Assets might 
                  ...
                  {"name": "Features", "description": """Explore data entries for a given dataset version 
                  (vector and tablular data only) in a classic RESTful way"""},
                  {"name": "Query", "description": """Explore data wentries for a given dataset version using standard SQL"""},
                  {"name": "Geostore", "description": """Retrieve a geometry using its mb5 hash for a given dataset, 
...
def custom_openapi():
    ...
    openapi_schema = get_openapi(
        title="GFW Data API", version="0.1.0", description="Use GFW Data API to manage and access GFW Data.",
        routes=app.routes,
    )
