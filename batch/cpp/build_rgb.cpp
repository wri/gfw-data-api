...
int main(int argc, char* argv[])
{
    ...
    //passing arguments
    if (argc != 4) {
        cout << "Use <program name> <date conf raster> <intensity raster> <output name>" << endl;
        return 1;
    }
    ...
    GDALDataset* INGDAL2;
    GDALRasterBand* INBAND2;

    //open file and get extent and projection
    INGDAL = (GDALDataset*)GDALOpen(in1_name.c_str(), GA_ReadOnly);
    ...
    INGDAL2 = (GDALDataset*)GDALOpen(in2_name.c_str(), GA_ReadOnly);
