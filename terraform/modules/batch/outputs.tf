...
output "pixetl_job_definition_arn" {
  value = aws_batch_job_definition.pixetl.arn
}

output "pixetl_job_definition" {
  value = aws_batch_job_definition.pixetl
}

output "pixetl_job_queue_arn" {
